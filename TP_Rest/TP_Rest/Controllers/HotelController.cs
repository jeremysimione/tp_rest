    ...
    public class HotelController : ApiController
    {
        ...
        HotelController()
        {
            ...
            if (cache["hotel"] == null)
            {
                ...
                h = new Hotel(chambres.Count, "montpellier", "31 rue de la mediterranee", "Le mediterraneen", 5, chambres);
        ...
        [Route("hotel/res/{b:int}-{nom}-{prenom}")]
        public String Getres(int b,string nom,string prenom)
        {
            return h.reserFinal(b, DateTime.Today, DateTime.Today.AddDays(4), nom, prenom);
        }
